...
exports.buildMergeReviewPrompt = buildMergeReviewPrompt;
function normalizeBranchName(value, fallback) {
    const trimmed = value?.trim();
    return trimmed && trimmed.length > 0 ? trimmed : fallback;
}
function buildMergeReviewPrompt(options) {
    ...
    const testingInstruction = projectTestingCommand && projectTestingCommand.length > 0
...
//# sourceMappingURL=mergeReviewPrompt.js.map