...
function buildEnsureAgenticHarnessSkillInstructions(details) {
    const { localSkillsDir, globalSkillsDir } = resolveAgenticHarnessSkillLocations(details.agenticHarnessCommand);
