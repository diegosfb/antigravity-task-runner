...
function getQuickActionItems() {
    ...
    const deployAgenticLibraries = new NodeItem({ kind: "category", label: "Deploy Agentic Libraries" }, vscode.TreeItemCollapsibleState.Collapsed);
...
function getDeployAgenticLibrariesItems() {
    ...
    const deploySdlc = new NodeItem({ kind: "action", label: "Deploy SDLC" }, vscode.TreeItemCollapsibleState.None);
    deploySdlc.iconPath = new vscode.ThemeIcon("cloud-upload", deployColor);
    deploySdlc.command = {
        command: "antigravity.deployAgenticLibSdlc",
        title: "Deploy SDLC"
    };
    const deploySdlcExtended = new NodeItem({ kind: "action", label: "Deploy SDLC Extended" }, vscode.TreeItemCollapsibleState.None);
    ...
    const deployProfessionalServices = new NodeItem({ kind: "action", label: "Deploy Professional Services" }, vscode.TreeItemCollapsibleState.None);
    ...
    const deployTechAdvisory = new NodeItem({ kind: "action", label: "Deploy Tech Advisory" }, vscode.TreeItemCollapsibleState.None);
