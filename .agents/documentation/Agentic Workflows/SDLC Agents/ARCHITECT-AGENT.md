...
> Source contract: [`architect-agent.md`](../../../agents/architect-agent/architect-agent.md). The source contract is authoritative if this summary and the contract differ.
...
- Invoke this agent only within the scope and activation rules defined in [`architect-agent.md`](../../../agents/architect-agent/architect-agent.md).
...
This page is synchronized from [the canonical agent contract](../../../agents/architect-agent/architect-agent.md) and its companion README. Update the canonical contract first when behavior changes.
