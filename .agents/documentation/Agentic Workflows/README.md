...
Generated inventory of agent workflow documentation. Existing authored pages are preserved; `agent-auditor` manages only marked inventory sections.
...
| `project-planner-agent` | SDLC Agents | [PROJECT-PLANNER-AGENT](SDLC%20Agents/PROJECT-PLANNER-AGENT.md) |
| `sdlc-orchestrator` | SDLC Agents | [SDLC-ORCHESTRATOR](SDLC%20Agents/SDLC-ORCHESTRATOR.md) |
| `spec-validation-agent` | Axiliary Agents | [SPEC-VALIDATION-AGENT](Axiliary%20Agents/SPEC-VALIDATION-AGENT.md) |
| `test-agent` | SDLC Agents | [TEST-AGENT](SDLC%20Agents/TEST-AGENT.md) |
| `ux-agent` | SDLC Agents | [UX-AGENT](SDLC%20Agents/UX-AGENT.md) |

## Usage guides

- [Meeting Evidence with Product Agent](SDLC%20Agents/MEETING-EVIDENCE-WITH-PRODUCT-AGENT.md) — add recordings, transcripts, or notes as reviewed PRD evidence.
