...
> Source contract: [`spec-validation-agent.md`](./spec-validation-agent.md). The source contract is authoritative if this summary and the contract differ.
...
- Invoke this agent only within the scope and activation rules defined in [`spec-validation-agent.md`](./spec-validation-agent.md).
