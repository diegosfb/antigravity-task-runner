...
> Source contract: [`mobile-architect.md`](./mobile-architect.md). The source contract is authoritative if this summary and the contract differ.

## What it does

Mobile design subagent of architect-agent. Owns mobile-client design decisions - native vs cross-platform, offline/sync strategy, mobile API contracts, push/notification architecture. Produces design input, never implementation. Dormant until a mobile client enters scope.
...
- Invoke this agent only within the scope and activation rules defined in [`mobile-architect.md`](./mobile-architect.md).
