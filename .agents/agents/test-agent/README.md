...
> Source contract: [`test-agent.md`](./test-agent.md). The source contract is authoritative if this summary and the contract differ.
...
- Invoke this agent only within the scope and activation rules defined in [`test-agent.md`](./test-agent.md).
