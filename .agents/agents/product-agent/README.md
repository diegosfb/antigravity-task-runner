...
> Source contract: [`product-agent.md`](./product-agent.md). The source contract is authoritative if this summary and the contract differ.
...
- Invoke this agent only within the scope and activation rules defined in [`product-agent.md`](./product-agent.md).
