...
> Source contract: [`project-planner-agent.md`](./project-planner-agent.md). The source contract is authoritative if this summary and the contract differ.
...
- Invoke this agent only within the scope and activation rules defined in [`project-planner-agent.md`](./project-planner-agent.md).
