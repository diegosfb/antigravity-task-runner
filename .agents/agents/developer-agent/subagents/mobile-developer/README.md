...
> Source contract: [`mobile-developer.md`](./mobile-developer.md). The source contract is authoritative if this summary and the contract differ.

## What it does

Mobile subagent of developer-agent. Implements iOS/Android native and cross-platform tasks from design specs and ADRs. Dormant until a mobile product enters scope.
...
- Invoke this agent only within the scope and activation rules defined in [`mobile-developer.md`](./mobile-developer.md).
