...
> Source contract: [`be-developer.md`](./be-developer.md). The source contract is authoritative if this summary and the contract differ.

## What it does

Backend subagent of developer-agent. Implements APIs, services, integrations, and AI/LLM features per the ADRs.
...
- Invoke this agent only within the scope and activation rules defined in [`be-developer.md`](./be-developer.md).
