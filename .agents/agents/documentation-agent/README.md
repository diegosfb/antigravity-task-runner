...
> Source contract: [`documentation-agent.md`](./documentation-agent.md). The source contract is authoritative if this summary and the contract differ.
...
- Invoke this agent only within the scope and activation rules defined in [`documentation-agent.md`](./documentation-agent.md).
