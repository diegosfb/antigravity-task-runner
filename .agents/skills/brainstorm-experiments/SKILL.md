...
Read `references/experiment-methods.md` when selecting among experiment types
or comparing evidence strength. See
`examples/ai-summarization-willingness-to-pay-experiment.md` for a complete
worked example.
