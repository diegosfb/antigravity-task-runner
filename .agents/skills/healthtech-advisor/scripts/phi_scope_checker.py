#!/usr/bin/env python3
"""
PHI Scope Triage — scan a healthtech product description for indicators that
may require HIPAA/health-data review. It does not determine PHI or legal scope.
