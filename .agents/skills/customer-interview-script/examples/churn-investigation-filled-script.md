...
- Hand this and the other 5 churn interviews to the interview-synthesis workflow to build an opportunity solution tree with the friction patterns at the top.
...
- Send the misattribution insight (price vs friction) to the customer-feedback-triage workflow so the CS team stops categorizing similar exits as "pricing."
