...
:                   : from datasources      :                                  :
| **dbt**           | SQL-first teams;      | `bigquery-transformation-frameworks` |
:                   : modular models with   :                                  :
:                   : built-in tests &      :                                  :
:                   : docs; all transforms  :                                  :
:                   : run inside BigQuery   :                                  :
...
:                   : Serverless data       :                                  :
:                   : processing            :                                  :
| **Dataform**      | Google-native ELT;    | `bigquery-transformation-frameworks` |
:                   : GCP Console           :                                  :
:                   : integration; SQLX/JS  :                                  :
:                   : for complex           :                                  :
...
dbt           | `bigquery-transformation-frameworks`
Dataflow      | `gcp-dataflow`
Dataform      | `bigquery-transformation-frameworks`
Spark         | `gcp-spark`
