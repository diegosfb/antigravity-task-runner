...
Compare fields in two structured contract versions and identify differences
under key headings. This is not a semantic legal redline or legal review.
    ...
    for change in changes:
        if change["clause"] in RISK_INDICATORS:
            ...
            risk_flags.append({
                ...
                "risk": ri["risk"] + "; qualified review required",
...
def main():
    parser = argparse.ArgumentParser(
        description="Structurally compare two JSON contract versions; not a legal redline."
    )
