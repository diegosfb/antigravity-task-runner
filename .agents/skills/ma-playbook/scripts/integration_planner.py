...
Creates a draft phased integration scaffold with proposed milestones and owners.
Every item requires transaction-specific validation and human authorization.
...
def generate_plan(mode, target_name, headcount, has_product_overlap, start_date):
    ...
    return {
        ...
        "disclaimer": "Planning scaffold only. Dates, owners, communications, personnel actions, access changes, migrations, and customer activities require validation and approval."
    }
