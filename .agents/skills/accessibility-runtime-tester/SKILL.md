...
description: Runtime accessibility testing - executes a11y checks against a running application (axe, keyboard nav, screen-reader flows) rather than static review. Use in the test phase to verify WCAG conformance on built UI. Attached to test-agent.
converted_from: extendedLib/agents/accessibility-runtime-tester
metadata:
  version: "2.0.0"
  library: "Local extendedLib / source not recorded"
  library-url: ""
  pack: "Software Development"
  based-on: "awesome-copilot https://awesome-copilot.github.com/agent/accessibility-runtime-tester/ agent"
---
