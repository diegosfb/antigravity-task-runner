...
def format_text(results: List[Dict[str, Any]]) -> str:
    ...
    lines.append("=" * 72)
    lines.append("Illustrative scenarios only: replace generic multipliers with the verified price book before forecasting or quoting.")
    lines.append("")
...
def format_json(results: List[Dict[str, Any]]) -> str:
    ...
    output = {
        ...
        "methodology_warning": "Monetary values use generic illustrative multipliers; they are not forecasts or quote-ready prices.",
        "summary": {
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Identify expansion signals and illustrative scenarios from adoption data."
    )
