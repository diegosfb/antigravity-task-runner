...
def format_text(results: List[Dict[str, Any]]) -> str:
    ...
    lines.append("=" * 72)
    lines.append("Heuristic output: validate completeness and calibrate thresholds before use.")
    lines.append("")
...
def format_json(results: List[Dict[str, Any]]) -> str:
    ...
    output = {
        ...
        "methodology_warning": "Configurable heuristic; not a prediction. Validate input completeness and calibrate thresholds before use.",
        "summary": {
