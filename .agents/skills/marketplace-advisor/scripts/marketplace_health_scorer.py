#!/usr/bin/env python3
"""
Marketplace Health Scorer — apply illustrative heuristics to a two-sided
marketplace's liquidity, balance, take rate, repeat rate, and supply density.
Thresholds are not universal benchmarks; calibrate them to the market unit.
