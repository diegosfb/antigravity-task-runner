...
- What coverage threshold and mandatory requirements has the authorized bid owner approved for this opportunity?
...
- Mention planned items only with product-owner approval; never present them as current capability or a delivery commitment
...
| Planned | Configurable | Authorized roadmap item, not currently available | Record approval status and any separately verified interim option |
