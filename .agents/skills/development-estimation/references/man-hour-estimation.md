# PERT, Man-Hour, and Staffing Estimation
...
**Supporting work to consider:**
Treat QA, coordination, and technical-lead work as explicit work items when the delivery scope requires them. Use project evidence rather than universal percentage overheads; if a provisional percentage is necessary, label it as an assumption and show its effect separately.
...
| … | | | | | | | |
| | **Dev Subtotal** | | | | | **Xh** | |
| | QA (stated basis) | QA | | | | **Xh** | |
| | Tech Lead review (stated basis) | TL | | | | **Xh** | |
| | Coordination (stated basis) | PM | | | | **Xh** | |
| | Contingency (X%) | — | | | | **Xh** | |
| | **GRAND TOTAL** | | | | | **Xh** | |
...
- QA, technical review, and coordination are rarely zero; include the applicable work explicitly and explain the basis.
