...
Priority order:
1. **Batch-upload CLI** - Most essential for production use
2. **Interactive-query CLI** - Interactive testing tool
3. **Cleanup CLI** - Utility for maintenance
...
2. Implement the batch-upload CLI
3. Implement the interactive-query CLI
...
3. Implement the batch-upload CLI (~150 lines)
4. Implement the interactive-query CLI (~100 lines)
