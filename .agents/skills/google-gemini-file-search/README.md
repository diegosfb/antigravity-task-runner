...
- Additional batch-upload, interactive-query, and cleanup utilities are roadmap items and are not bundled.
...
- `references/README.md` - Roadmap for planned API, chunking, pricing, and migration guides
