---
name: accessibility
description: Web accessibility (WCAG 2.1/2.2), inclusive UX, and a11y review. Use when defining accessibility criteria for design tasks, reviewing UI for inclusive design, or auditing components against WCAG. Attached to ux-agent (design-time criteria) and usable by test-agent for a11y checks.
converted_from: extendedLib/agents/accessibility (Accessibility Expert)
metadata:
  version: "2.0.0"
