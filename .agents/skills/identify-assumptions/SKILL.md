...
Read `references/assumption-mapping-guide.md` when facilitating a collaborative
mapping session or calibrating confidence and impact scores. See
`examples/shared-dashboards-assumption-mapping.md` for a complete worked
example.
