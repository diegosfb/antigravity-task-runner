...
export const SOLUTION_ARCHITECT_COMMAND = "antigravity.openSolutionArchitect";

export type SolutionArchitectFormValues = {
  agentHarness: string;
  agentModel: string;
...
export function getDefaultSolutionArchitectValues(
...
export function getMissingSolutionArchitectFields(
...
export function buildSolutionArchitectCommand(values: SolutionArchitectFormValues): string {
  const parts = [
...
export function renderSolutionArchitectHtml(
  webview: vscode.Webview,
  initialValues: SolutionArchitectFormValues
): string {
