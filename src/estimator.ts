...
export const ESTIMATOR_COMMAND = "antigravity.openEstimator";
...
export function getDefaultEstimatorValues(workspaceRoot?: string): EstimatorFormValues {
...
export function sanitizeEstimatorFormValues(
  values: Partial<EstimatorFormValues> | undefined,
...
export function getMissingEstimatorFields(values: EstimatorFormValues): string[] {
...
export function buildEstimatorCommand(values: EstimatorFormValues): string {
  const parts = [
...
export function renderEstimatorHtml(
