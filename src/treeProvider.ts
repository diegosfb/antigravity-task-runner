...
function getQuickActionItems(): NodeItem[] {
  ...
  if (!savedJiraProjectKey) {
    ...
    const addJiraItem = new NodeItem(
      { kind: "action", label: "Create Backlog item" },
      vscode.TreeItemCollapsibleState.None
    );
    ...
    const completeJiraItem = new NodeItem(
      { kind: "action", label: "Backlog Item Completed" },
      vscode.TreeItemCollapsibleState.None
    );
...
function getAdlcItems(): NodeItem[] {
  ...
  const estimator = new NodeItem(
    { kind: "action", label: "Estimate Project" },
    vscode.TreeItemCollapsibleState.None
  );
  ...
  const planExecution = new NodeItem(
    { kind: "action", label: "Create Execution Plan" },
    vscode.TreeItemCollapsibleState.None
  );
...
function getClaudeActionItems(): NodeItem[] {
  ...
  const opencode = new NodeItem(
    { kind: "action", label: "Opencode" },
    vscode.TreeItemCollapsibleState.None
  );
  opencode.iconPath = new vscode.ThemeIcon("robot", CLAUDE_ACTION_COLOR);
  opencode.command = {
