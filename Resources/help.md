...
| `Update Project Config` | A collapsed section right after `Setup Workspace` that groups agent-driven project configuration updates. | Expand it when you want to run one of the focused project config update prompts below. | Always |
